...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('courier_cars_schedules', function (Blueprint $table) {
            ...
            $table->enum('trip_type', ['pickup', 'delivery'])->comment('Jenis trip: pickup (ambil dari resort) atau delivery (antar ke resort)');
            $table->json('resort_ids')->comment('Array ID resort yang dikunjungi (JSON)');
