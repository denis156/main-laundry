...
<x-dynamic-component :component="$layoutView">
    ...
    <section class="bg-base-100">
        {{-- Header --}}
        <x-header icon="solar.station-minimalistic-line-duotone" icon-classes="text-error w-6 h-6"
            title="Tidak Ada Koneksi" subtitle="Aplikasi tidak dapat terhubung ke server" separator />

        <div class="space-y-4">
            {{-- Status Card --}}
            <x-card class="bg-base-300 shadow" title="Status Koneksi" subtitle="Periksa koneksi internet Anda" separator>
                ...
                <x-slot:actions separator>
                    {{-- Back to Home --}}
                    <x-button link="{{ $this->getBerandaRoute() }}" icon="solar.home-bold-duotone"
                        label="Kembali ke Beranda" class="btn-secondary" />
                ...
                <ul class="space-y-3">
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-base-content/70">Pastikan Anda berada di area dengan sinyal yang baik
                            </p>
                        </div>
                    </li>
                </ul>
