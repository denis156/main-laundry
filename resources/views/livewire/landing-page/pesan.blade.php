                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        ...
                                        <label class="cursor-pointer">
                                            <input type="radio"
                                                   wire:model="payment_timing"
                                                   value="on_pickup"
                                                   class="radio radio-accent hidden peer" />
                                            <div class="card border-2 border-base-300 hover:border-accent peer-checked:border-accent peer-checked:bg-accent/5 transition-all">
                                                <div class="card-body p-4">
                                                    <div class="flex items-start gap-3">
                                                        ...
                                                        <div class="flex-1">
                                                            ...
                                                            <p class="text-sm text-base-content/70">Bayar setelah cucian ditimbang</p>
                                                        </div>
                                                ...
                                                <div class="card-body p-4">
                                                    <div class="flex items-start gap-3">
                                                        ...
                                                        <div class="flex-1">
                                                            ...
                                                            <p class="text-sm text-base-content/70">Bayar saat cucian diantar kembali</p>
                                                        </div>
                                                        <div class="peer-checked:block hidden">
                                                            <x-icon name="o-check-circle" class="w-5 h-5 text-accent" />
                                                        </div>
