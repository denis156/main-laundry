        ...
        return $schema
            ->components([
                Section::make('Informasi Kurir')
                    ->description('Data lengkap kurir termasuk identitas, kontak, kendaraan, dan penugasan lokasi')
                    ->collapsible()
                    ->schema([
                        Grid::make([
                            'default' => 1,
                            ...
                            ->schema([
                                FileUpload::make('data.avatar_url')
                                    ...
                                    ->helperText('Opsional. Maksimal 2MB')
                                ...
                                Fieldset::make('Akun Kurir')
                                    ...
                                    ->schema([
                                        ...
                                        TextInput::make('data.vehicle_number')
                                        ...
                                        Select::make('assigned_location_id')
                                            ...
                                            ->helperText('Lokasi (Resort/POS) tempat kurir ini ditugaskan')
                                            ->columnSpanFull(),

                                        ToggleButtons::make('data.is_active')
                                            ->label('Status Kurir')
                                            ->boolean()
                                            ->grouped()
                                            ->required()
                                            ...
                                            ->helperText('Kurir aktif dapat menerima tugas pengiriman')
                                            ->columnSpanFull(),
                                        ...
                                        TextInput::make('password')
                                            ...
                                            ->helperText(fn(string $operation): string => $operation === 'edit' ? 'Kosongkan jika tidak ingin mengubah password' : 'Password untuk login kurir')
                                            ->columnSpanFull(),
                                    ])
                ...
                Section::make('Tanggal & Waktu')
                    ->description('Riwayat tanggal dan waktu pembuatan dan update terakhir data kurir')
                    ->collapsible()
                    ->schema([
                        Grid::make([
                            'default' => 1,
